...
Armlet.MenuPath = {"MrGarabato","Utility", "Armlet Abuse"}

Armlet.ArmletEnabled = Menu.AddOptionBool(Armlet.MenuPath, "Enable", false)
Armlet.HPTreshold = Menu.AddOptionSlider(Armlet.MenuPath, "HP threshold", 100, 1000, 50)
...
local ArmletSettings = require "scripts.settings.Armlet";
